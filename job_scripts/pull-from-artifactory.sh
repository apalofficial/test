...
skopeo copy --src-tls-verify=false --src-cert-dir /tmp/registry-certs docker://staging.docker.akamai.com:5433/build-images-development/basic_connector/image:0.1-$JOB_ID 
